...
module UserSample =
    ...
    let __Surface_17() =
        ...
        for i in 0..N_cycle do
            ...
            //if (changes.[2] = 1) && (changes.[0] = 1) && (changes.[5] = 0) then show "%s error on data qubit 1 occurred. Applying fix." sZ; Z ket.Qubits.[1..1]; flag <- 1; redundant
            ...
            //if (changes.[3] = 1) && (changes.[4] = 0) && (changes.[6] = 1) then show "%s error on data qubit 5 occurred. Applying fix." sX; X ket.Qubits.[5..5]; flag <- 1; redundant
            ...
            //if (changes.[4] = 1) && (changes.[1] = 1) && (changes.[3] = 0) then show "%s error on data qubit 3 occurred" sX; redundant
            //if (changes.[4] = 1) && (changes.[1] = 0) && (changes.[3] = 1) then show "%s error on data qubit 4 occurred" sX; redundant
            ...
            //if (changes.[5] = 1) && (changes.[2] = 1) && (changes.[7] = 0) then show "%s error on data qubit 4 occurred" sZ; redundant
            ...
            //if (changes.[7] = 1) && (changes.[5] = 1) then show "%s error on data qubit 7 occurred" sZ; redundant
